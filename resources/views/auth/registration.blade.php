...
{{-- lg-large --}}
                        ...
                        <div class="col-lg-4">
                           <input type="text" name="name" class="form-control inputnew" placeholder="Enter your name"/>
                        </div>
                        @if($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                           <input type="tel" name="phone" class="form-control inputnew"  placeholder="Enter your phone number"/>
                        </div>
                        @if($errors->has('phone'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                           <input type="password" name="password" class="form-control inputnew"  placeholder="Enter your password"/>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                           <input type="submit" name="submit" class="btn btn-primary button" value="Registration"/>
                           {{-- keep space between the class names when adding a style  --}}
